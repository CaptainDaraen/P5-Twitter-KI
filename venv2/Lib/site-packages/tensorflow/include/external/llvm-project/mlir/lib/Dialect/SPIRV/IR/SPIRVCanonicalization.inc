...
void LLVM_ATTRIBUTE_UNUSED populateWithGenerated(::mlir::MLIRContext *context, ::mlir::OwningRewritePatternList &patterns) {
  ...
  patterns.insert<ConvertComparisonIntoClampSPV_FOrdLessThanEqualOp>(context);
  patterns.insert<ConvertComparisonIntoClampSPV_FOrdLessThanOp>(context);
  patterns.insert<ConvertComparisonIntoClampSPV_SLessThanEqualOp>(context);
  patterns.insert<ConvertComparisonIntoClampSPV_SLessThanOp>(context);
  patterns.insert<ConvertComparisonIntoClampSPV_ULessThanEqualOp>(context);
  patterns.insert<ConvertComparisonIntoClampSPV_ULessThanOp>(context);
